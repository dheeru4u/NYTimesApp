 ...
 */
public abstract class ArticlesEndlessScrollListener extends RecyclerView.OnScrollListener {
    ...
    private final static String  TAG = ArticlesEndlessScrollListener.class.getSimpleName();
    ...
    public ArticlesEndlessScrollListener(LinearLayoutManager layoutManager) {
        init();
        this.mLayoutManager = layoutManager;
    }

    public ArticlesEndlessScrollListener(GridLayoutManager layoutManager) {
        init();
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
        Log.d(TAG, "ArticlesEndlessScrollListener: layoutManager.getSpanCount() "+layoutManager.getSpanCount());
        Log.d(TAG, "ArticlesEndlessScrollListener:  visibleThreshold "+visibleThreshold);
    }

    public ArticlesEndlessScrollListener(StaggeredGridLayoutManager layoutManager) {
        init();
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
    }
