...
import com.dheeru.app.news.util.DatePickerFragment;
 ...
 */
public class SearchFilterFragmentActivity  extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.search_filter_frament, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                updateNewsDesk();
                updateSortOrder();
                ((SearchActivity)getActivity()).repeatSearch();
                dismiss();
            }
        });
        ...
        beginDateEditText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                newFragment.setTargetFragment(SearchFilterFragmentActivity.this, 300);
